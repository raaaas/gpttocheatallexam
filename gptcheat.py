...
def take_bounded_screenshot(x1, y1, x2, y2):
    ...
    image_to_text("snips/" +  file_name + ".png")
...
class Application():
    def __init__(self, master):
        ...
        self.snipButton = Button(self.buttonBar, width=5, height=5,
                                 command=self.create_screen_canvas, background="green")
